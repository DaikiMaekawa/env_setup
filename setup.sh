...
sudo aptitude install nkf git screen vim rubygems1.9.1 ruby1.9.1-dev ipython g++ trash-cli ${pdf_viewer} ${image_viewer} ${image_editor} ${desktop_capture} ${video_editor}
#./ros_setup.sh
