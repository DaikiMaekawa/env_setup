...
sudo aptitude install -y nkf git screen vim rubygems1.9.1 ruby1.9.1-dev ipython g++ trash-cli python-pip lyx ${pdf_viewer} ${image_viewer} ${image_editor} ${desktop_capture} ${video_editor} ${webdav_client} meshlab
#./ros_setup.sh
